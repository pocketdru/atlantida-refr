                ...
                <div className="col-md-12">
                        ...
                        <div className="row gallery mt-5">
                            <div className="col-md-3 col-sm-6 p-0">
                                <img src="/images/blog/Image2.png" className="img-fluid mw-auto" alt="gallery-photo"/>
                                <div className="img-fluid mw-auto" alt="gallery-photo">
                            ...
                            <div className="col-md-3 col-sm-6 p-0">
                                ...
                                <img src="/images/blog/Image4.png" className="img-fluid mw-auto" alt="gallery-photo"/>
                            </div>
                            <div className="col-md-3 col-sm-6 p-0">
                                <img src="/images/blog/Image5.png" className="img-fluid mw-auto" alt="gallery-photo"/>
                                <div className="img-fluid mw-auto" alt="gallery-photo">
                                    <div className="card mb-3">
                                        <div className="card-body">
                                            <p className="card-text">14 Aug 2015 / By Admin</p>
                            ...
                            <div className="col-md-3 col-sm-6 p-0">
                                ...
                                <img src="/images/blog/Image6.png" className="img-fluid mw-auto" alt="gallery-photo"/>
                            </div>
                        </div>
                    </div>
                </div>
