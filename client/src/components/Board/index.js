          ...
          <div className="colm-md-12">
            <div className="card">
              ...
              <div className="card-body">
                <h2 className="card-title text-center mt-5">About us
                <span><WavySvg/></span>
                </h2>
                ...
                <button type="button" className="btn btn-outline-primary mx-auto">Contact Us</button>
                <button type="button" className="btn btn-outline-secondary mx-auto">Portfolio</button>
              </div>
          </div>
          </div>
        </div>
