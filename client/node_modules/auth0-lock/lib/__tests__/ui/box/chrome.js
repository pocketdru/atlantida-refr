...
describe('Chrome', function () {
  ...
  it('correctly sets the header size when the "signin ready" event is triggered', function () {
    var component = (0, _reactTestRenderer.create)(_react2.default.createElement(Chrome, defaultProps));
  ...
  it('correctly sets the header size when the "signup ready" event is triggered', function () {
    var component = (0, _reactTestRenderer.create)(_react2.default.createElement(Chrome, defaultProps));
    var instance = component.getInstance();
